...
class DenseLayer(nn.Sequential):
    ...
    def forward(self, x):
        ...
        print(out)
        raise ValueError(
            "this should be two items (regularization) or something is wrong"
        )
...
class TransitionUp(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        print(
            "TransitionUp: WARNING: you might need to make a CD layer for conv transpose"
        )
